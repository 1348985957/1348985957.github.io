...
$cfg_cmspath = '';
$cfg_cookie_encode = 'WI1GwEHhoFxE5sVV86t7VFqpX5fAsYDG';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '首页';
$cfg_webname = '（自适应手机版）响应式新闻资讯网站源码 HTML5个人技术博客类织梦模板 - AB模板网 - Www.AdminBuy.Cn';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; Www.AdminBuy.Cn 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_notice = '该模板为AB模板网VIP资源，加入VIP即可下载全站所有模板，本站也承接仿站业务，联系QQ：94490489';
$cfg_txqq = 9490489;
$cfg_weibo = 'http://www.weibo.com/gooxao';
$cfg_tweibo = 'http://t.qq.com/gooxao2';
$cfg_logotxt = '我的网站，可以后台设置此处文字！';
$cfg_hy = '本站有AB模板网提供技术支持 Www.AdminBuy.Cn';
$cfg_xm = 'AB模板网';
$cfg_js = '男，文化程度不高性格有点犯二，已经20来岁至今未婚，闲着没事喜欢研究各种代码，资深技术宅。';
?>